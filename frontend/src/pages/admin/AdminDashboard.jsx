...
function AdminDashboard() {
  ...
  const adminSections = [
    ...
    },
    {
      ...
      path: '/admin/groups',
      module: 'groups',
      description: 'Manage OTS groups and sync from server',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Create and manage onboarding invitation codes',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Manage pending email verifications and registrations',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      module: 'tak_profiles',
      description: 'Upload and manage TAK client profiles',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      module: 'meshtastic',
      description: 'Manage Meshtastic channels synced from OTS',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      module: 'meshtastic',
      description: 'Group channels (up to 8) for combined QR codes',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      path: '/admin/radios',
      module: 'radios',
      description: 'Track and assign radio equipment',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      path: '/admin/api-docs',
      module: 'api_docs',
      description: 'View API documentation and usage guides',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
