...
ITAK_PORT=str(environ.get('ITAK_PORT', '8089'))
ITAK_HOMEPAGE_ICON_ENABLED=strtobool(environ.get('ITAK_HOMEPAGE_ICON_ENABLED', 'True'))
TRUSTSTORE_HOMEPAGE_ICON_ENABLED=strtobool(environ.get('TRUSTSTORE_HOMEPAGE_ICON_ENABLED', 'True'))
